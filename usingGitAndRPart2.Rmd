...
Go back now to your GitHub repository and click [Settings] from the top menu. Scroll down to the section labelled `GitHub Pages`. Under 'Source', set 'Branch' to `main` and the folder to `docs/` (if you don't see this folder, it was not not uploaded in the commit).
