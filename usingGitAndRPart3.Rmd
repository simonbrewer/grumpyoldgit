...
This will just create a blank text file in your repository (sorry - the script is a secret). If you check git's status, it should list this file as an untracked change. 
```
