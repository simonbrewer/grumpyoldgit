...
Once submitted, you'll see a page containing all the details that you added, as well as a message stating if there are any conflicts between the two branches. At the same time, an emai lwill have been sent to the owner of the original repository informing them of the pull request. 
