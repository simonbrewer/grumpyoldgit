...
In this section, we'll look at how you can collaborate on the code in someone else's repository, so you will need to work in pairs or small groups. To start:
...
Save and run your script, and if it all works, commit and push this to GitHub (note that this will push the previous commit as well). Finally, go back to your browser and check that everything has uploaded correctly. 
