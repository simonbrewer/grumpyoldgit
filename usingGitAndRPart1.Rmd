...
The last of these commands will provide information about where this would cloned from, information about where the master repository is held, and whether or not the local clone copy is up-to-date (it is for now). 
