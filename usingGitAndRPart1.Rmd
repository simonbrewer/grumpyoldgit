...
GitHub is one of several online hosting sites, that provide cloud-based storage for your git repositories (other options are GitLab and Bitbucket). This (and git) now integrate quite seamlessly with R, and particularly with RStudio, so in the next lab, we'll go through the steps of setting up R and GitHub to play nicely together. 
